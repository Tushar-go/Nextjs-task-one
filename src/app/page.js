...
import Logo from "../../public/assets/HobbyCue Logo.png"
import SearchBox from "../../public/assets/SearchBox.png";
import NavElements from "../../public/assets/nav-elements.png";
import mobileBell from "../../public/assets/notifications_black_24dp 1.png";
import mobileSearch from "../../public/assets/icons8_search 1.png";
import Menu from "../../public/assets/menu_black_24dp 1.png";
import SignIn from "../../public/assets/Sign In Form.png";
import GroupPic from "../../public/assets/Group 27.png";
...
import Player from "../../public/assets/Audio Track.png";
import UserPhoto from "../../public/assets/User.png";
import Banner from "../../public/assets/Banner.png";
import Links from "../../public/assets/Bottom-links.png";
...
export default function Home() {
  return (
    ...
    <nav className=" flex items-center justify-around bg-white p-2 ">
      ...
      <div className=" sm:block hidden">
        <Image src={NavElements} alt="navEl" />
      </div>
      <div className=" flex flex-row gap-2 sm:hidden">
        <div>
          <Image src={mobileSearch} alt="search" />
        </div>
        <div>
          <Image src={mobileBell} alt="bellicon" />
        </div>
        <div>
    ...
    <main className="bg-[#F7F5F9] w-screen grid sm:grid-cols-4 gap-6 pt-10 sm:pl-12 ">
      ...
      <div className=" min-h-[100px]  sm:col-span-2 sm:row-span-2">
        <div className=" flex flex-row justify-center">
          <Image className=" w-[340px] " src={SignIn} alt="signin" />
        </div>
      </div>
      <div className="sm:col-span-2 mt-4">
        <Image src={GroupPic} alt="photo" />
      </div>
    </main>
    {/* {second layer} */}
    ...
    <main className=" grid sm:grid-cols-4 mt-10 gap-2 my-6">
      <div className=" min-h-[100px] mx-24 sm:mx-0 sm:col-start-2 sm:col-end-3 ">
        ...
        <div className=" flex flex-col gap-4 border rounded-md p-4">
          <div className="flex flex-row sm:justify-start justify-center">
            <Image className=" w-[100px]" src={People} alt="people" />
          </div>
      ...
      <div className="min-h-[100px] mx-24 sm:mx-0  sm:col-start-3 sm:col-end-4">
        <div className=" flex flex-col gap-4 border rounded-md p-4">
          <div className=" flex flex-row sm:justify-start justify-center ">
            <Image className=" w-[90px]" src={Place} alt="place" />
          </div>
          <p className=" text-xs sm:text-start text-center">
      ...
      <div className=" min-h-[100px] mx-24 sm:mx-0  sm:col-start-2 sm:col-end-3">
        <div className=" flex flex-col gap-4 border rounded-md p-4">
          <div className="flex flex-row sm:justify-start justify-center">
            <Image className=" w-[100px]" src={Product} alt="product" />
          </div>
          <p className=" text-xs sm:text-start text-center">
      ...
      <div className=" flex flex-col gap-4 border rounded-md p-4 min-h-[170px]">
          <div className="flex flex-row sm:justify-start justify-center">
            <Image className=" w-[100px]" src={Program} alt="program" />
          </div>
          <p className=" text-xs sm:text-start text-center">
    ...
    <main className=" min-h-[250px] grid grid-cols-4 sm:pl-8  mt-8">
       <div className=" bg-[#F7FDFF] col-span-4 mx-8 my-6 ">
          <div className=" bg-white mx-8 my-10 sm:mx-36 sm:my-14 flex flex-col gap-3 border rounded-md p-3">
            <div>
            <Image className=" w-[200px]" src={Add} alt="Add" />
            </div>
    ...
    <main className=" grid sm:grid-cols-4  mt-8 p-6 bg-[#F7F5F9] rounded-md mx-11 sm:mx-40">
          ...
          <div className=" flex flex-row sm:justify-start justify-center ">
            <Image className=" w-[180px] " src={Testimonials} alt="Testimonials" />
          </div>
          ...
          <div className=" flex flex-row sm:justify-start justify-center  ">
            <Image className="sm:w-[640px] sm:h-[80px]" src={Player} alt="Testimonials" />
          </div>
          <div className="flex flex-row sm:justify-start justify-center">
          <Image className=" w-[180px] sm:h-[60px] " src={UserPhoto} alt="Testimonials" />
          </div>
            </div>
          </div>
